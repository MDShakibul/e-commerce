...
@csrf
						  <fieldset>
                            ...
                            <div class="control-group hidden-phone">
							  ...
							  <div class="controls">
								<textarea class="cleditor" id="textarea2" name="product_short_discription"rows="3" required></textarea>
							  </div>
							</div>
                            ...
                            <div class="control-group hidden-phone">
							  ...
							  <div class="controls">
								<textarea class="cleditor" id="textarea2" name="product_long_discription"rows="3" required></textarea>
							  </div>
							</div>
